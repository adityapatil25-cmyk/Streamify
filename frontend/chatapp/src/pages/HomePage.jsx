...
const HomePage = () => {
  ...
  */
  ...
  onSuccess: (_data, variables) => {
    setOutgoingRequestsIds((prev) => new Set(prev).add(variables.recipientId));
    queryClient.invalidateQueries({ queryKey: ["outgoingFriendReqs"] });
  }
});
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      <button
                        ...
                        onClick={() =>
                          sendRequestMutation({ recipientId: user._id })
                        }
...
// Dummy function placeholder (keep your actual one in real app)
